...
/// Yields (depth, start_ns, duration_ns) for all shadows visible in the time range.
/// Iterates the tree directly to get the shadow ranges.
pub fn visible_shadows_in<'a>(
